...
import { DeleteButtonProps } from '../../../../js/renovation/scheduler/appointment-tooltip/delete-button';
...
describe('DeleteButton', () => {
  describe('View', () => {
    const render = (props = {}): ReactWrapper => {
      window.h = h;
      return mount(<DeleteButton {...(new DeleteButtonProps())} {...props} />).childAt(0);
    };
